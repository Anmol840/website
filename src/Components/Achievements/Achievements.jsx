          ...
          <div className="mt-10 mb-16 px-4 max-w-screen-lg mx-auto">
            ...
            <div className="flex flex-col items-center justify-center space-y-4 bg-[#212121] rounded-lg p-6 shadow-md text-center mt-8">
              <p className="text-base sm:text-lg md:text-xl leading-relaxed text-white font-light max-w-2xl">
                ...
                Acquired practical experience working directly with vehicles.
                ...
                Gained insights into diverse technical disciplines, expanding knowledge beyond our primary focus.<br /><br />
                ...
                Expanded understanding beyond the technical realm to include non-technical areas, such as media handling.<br /><br />
                ...
                Demonstrated proficiency in managing time effectively, balancing academic and club responsibilities.
                <br /><br />
                ⮚<b><span
                  style={{
                    fontFamily: "sans-serif",
                ...
                Gained knowledge about the market dynamics and trends related to vehicles.<br /><br />
