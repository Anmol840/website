...
const movies = [
  { name: "Sumit Patil", des: "Vehicle Dynamics", img: M3, link: "https://www.linkedin.com/in/anmol-gour-4455a6305/" },
  { name: "Mayur Bhosale", des: "Vehicle Dynamics", img: M3, link: "https://www.linkedin.com/in/anmol-gour-4455a6305/" },
  { name: "Rushikesh Bhasme", des: "Vehicle Dynamics", img: M3, link: "https://www.linkedin.com/in/anmol-gour-4455a6305/" },
  { name: "Anmol Kitchloo", des: "Vehicle Dynamics", img: M3, link: "https://www.linkedin.com/in/anmol-gour-4455a6305/" },
  { name: "Aditya Patil", des: "Vehicle Dynamics", img: M3, link: "https://www.linkedin.com/in/anmol-gour-4455a6305/" },
];
...
const MoviesCarousel = () => {
  ...
  useEffect(() => {
    if (paused) return; // stop interval when paused
